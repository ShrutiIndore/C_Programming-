//Accept N number from user As well as 1 another number  and check wheather it is present or not (Optimization)            optimation means making loop small use break;
